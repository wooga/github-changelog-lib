...
interface ChangeDetector<B> {
    ...
    B detectChangesFromSha(String from, String to, String branchName) throws ChangeDetectorException

    B detectChangesFromTagToHead(String from) throws ChangeDetectorException
    B detectChangesFromTagToHead(String from, String branchName) throws ChangeDetectorException
    B detectChangesFromTag(String from, String to) throws ChangeDetectorException
    B detectChangesFromTag(String from, String to, String branchName) throws ChangeDetectorException
}